...
ITPortal is an internal institutional platform for the Grupo Bravante IT department.
...
## 7. Brand Identity Reference (Grupo Bravante)

### Color Palette

| Name             | Hex       | Usage                    |
|------------------|-----------|--------------------------|
| Verde Bravante   | #007B4E   | Primary, headers, nav    |
| Amarelo Bravante | #EAAB00   | Accents, CTAs, icons     |
| Verde 70%        | #629676   | Secondary backgrounds    |
| Amarelo 45%      | #FCD798   | Light accents            |
| Cinza Bravante   | #989AA5   | Body text, borders       |
...
- Brand palette enforced via `--verde-bravante`, `--amarelo-bravante`, `--cinza-bravante` tokens.
