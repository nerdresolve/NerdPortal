...
Quando o portal for publicado em um servidor com dominio definido (ex: `portal.example.com`), os seguintes pontos precisam ser atualizados:
...
| `NEXT_PUBLIC_API_URL` | `http://localhost:4000/api/v1` | `https://api.portal.example.com/api/v1` (ou o caminho da API no mesmo dominio) |
...
NerdResolve - Tecnologia da Informacao
ITPortal v0.1.0
